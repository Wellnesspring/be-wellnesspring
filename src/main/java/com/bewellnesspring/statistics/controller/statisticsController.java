...
public class statisticsController {
    ...
    @GetMapping("")
    public List<Map<String,Object>> allList(@RequestParam String id){
    ...
    public List<Map<String,Object>> sportList(@RequestParam String id){
    ...
    public List<Map<String,Object>> kcalList(@RequestParam String id) {
    ...
    @GetMapping("food")
    public List<Map<String,Object>> foodList(@RequestParam String id){
        List<Map<String,Object>> foodList = statisticsService.getFoodData(id);
        logger.info(foodList.toString());
        return foodList;
    }
    @GetMapping("level")
    public List<Map<String,Object>> levelList(@RequestParam String id){
    ...
    @GetMapping("avg")
    public List<Map<String,Object>> avgList(@RequestParam String id){
