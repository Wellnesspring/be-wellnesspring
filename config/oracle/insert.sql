...
VALUES ('user01', 0, 'pw01', '홍길동', '960606','1122334','010-1234-1234',175,70,SYSDATE,'abcd','img',1 );

INSERT INTO users(
    user_id,ROLE, user_pw, name, serial_num_f, serial_num_l, phone, height, weight, join_at, alarm_agree, profileImg, point)
VALUES ('user02', 0, 'pw02', '김민지', '940202','2122334','010-5678-5678',182,78,SYSDATE,'abcd','img',1 );
